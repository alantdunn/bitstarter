...
var stringifyOption = function(optionval) {
    var strOption = optionval.toString();
    return strOption;
}
...
if(require.main == module) {
    program
        ...
        .option('-u, --url <url>', 'URL to index.html', clone(stringifyOption), URL_DEFAULT)
        .parse(process.argv);
